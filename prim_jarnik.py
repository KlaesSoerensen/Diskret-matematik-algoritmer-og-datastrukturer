...
for arg in sys.argv:
    ...
    if arg.startswith("start="):
        ...
        nodes = arg.split("=")[1].strip().replace("\"", "").split(
            ",")  # a: e 12, b: a 12 c 12, c: f d, d: d f, e: b h, f: i, g: e, h: g i c, i: j, j: f
...
mst, mst_order = g.prim_jarnik(startNode)
...
print("\nOrder of nodes added to the MST:")
print(" -> ".join(mst_order))
